...
const faqs = [
  ...
  { question: "What's included in the free plan?", answer: "The free plan includes 100 email verifications to test our service. You can validate single emails and see how MailVet works. No credit card required. When you're ready for unlimited verifications, upgrade to our Ultimate plan." },
  { question: "What does 'unlimited verifications' mean?", answer: "With our Ultimate plan at $29.99/month (90% off from $299), you get truly unlimited email verifications. There are no per-email charges, no monthly caps, and no hidden fees. Verify 1,000 or 1,000,000 emails—your price stays the same. This is unique to MailVet; competitors typically charge $0.001-$0.01 per email." },
  ...
  { question: "What payment methods do you accept?", answer: "We accept all major credit cards (Visa, Mastercard, American Express), PayPal, and bank transfers for enterprise customers. All payments are securely processed through Stripe with bank-level encryption." },
  ...
  { question: "What's included in the Enterprise plan?", answer: "Enterprise includes everything in Ultimate plus: full API access, super-fast processing, unlimited concurrent file uploads, a dedicated account manager, custom integrations, and SLA guarantees. Contact our sales team for custom pricing based on your needs." },
  ...
  { question: "Are there any rate limits?", answer: "The Ultimate plan includes 3 emails/second verification rate and up to 2 concurrent file uploads with max 10,000 rows per file. For higher throughput and unlimited concurrent files, our Enterprise plan offers super-fast processing tailored to your needs." },
];
